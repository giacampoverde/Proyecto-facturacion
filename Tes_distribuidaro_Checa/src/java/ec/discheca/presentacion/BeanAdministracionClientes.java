...
@ManagedBean
@ViewScoped
public class BeanAdministracionClientes implements Serializable {
...
//rebisar  esta dando fallas
    ...
    public BeanAdministracionClientes() {
        ...
        if (validarDatosCliente()) {
            try {
                ...
                if (clientGuardado != null) {
                    ...
                    usuario_interno.setApellidoUsuario("");
    ...
    public static boolean enviarCorreoRestablecerClave(UsuarioAcceso _usuario) {
        ...
        try {
            ...
            if (_usuario.getCorreoPrincipalUsuario() != null && !_usuario.getCorreoPrincipalUsuario().equals("")) {
                ...
                if(respuesta){
                    Logger.getLogger(Notificacion.class.getName()).log(Level.INFO, "Correo enviado a :"+_usuario.getCorreoPrincipalUsuario());
                }
            }
        } catch (Exception ex) {
...
//                clienteselec.setRucReceptor(actualizado.getRucReceptor());
                ...
                Logger.getLogger(BeanAdministracionClientes.class.getName()).log(Level.INFO, "El usuario: " + cs.obtenerNombreUsuarioSesionActiva() + " ha modificado al cliente: " + this.clienteselec.getRucReceptor() + ".");
                cargarDatatableConCliente();
            } else {
