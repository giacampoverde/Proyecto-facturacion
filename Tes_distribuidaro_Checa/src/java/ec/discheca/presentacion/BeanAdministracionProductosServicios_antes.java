...
@ManagedBean
@ViewScoped
public class BeanAdministracionProductosServicios_antes implements Serializable {
    ...
    public BeanAdministracionProductosServicios_antes() {
    ...
    public void guardarLogRegistros(String mensaje) {
        try {
            ...
            Logger.getLogger(BeanAdministracionProductosServicios_antes.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                    info_empresa = productos.get(0).getEmpresa().getNombreComercialClienteEmpresa() + " RUC: " + productos.get(0).getClienteEmpresa().getIdClienteEmpresa();
            ...
            Logger.getLogger(BeanAdministracionProductosServicios_antes.class.getName()).log(Level.SEVERE, "Error al cargar los productos", e);
        }
    }
...
//        }
    ...
    public boolean validarProducto() {
        ...
        try {
            ...
            } else if (precioCosto.scale() > 6) {
                mostrarMensajeDialog(FacesMessage.SEVERITY_ERROR, "El precio debe ser un número con máximo 6 decimales.");
...
//                    break;
            ...
            if (!validarProductoRepetido(productoActualizado.getDescripcion(), productoActualizado.getCodigoProducto())) {

                for (Producto producto : productos) {
                    if (producto.getIdproducto().equals(productoActualizado.getIdproducto())) {
                        actualizar = a.actualizarProducto(productoSeleccionado.getIdproducto(), productoActualizado);
                        if (actualizar) {
                            cargarDatatableConProductos();
                        }
                        break;
            ...
            if (Validaciones.esDecimal(precioVenta.toString())) {
                if (precioVenta.compareTo(BigDecimal.ZERO) < 1) {
                    ...
                    if (Utilidades.BorrarCaract(precioVenta.toString(), "\\.").length() > 18) {
                        ...
                        if (precioVenta.scale() > 6) {
                            aux5 = false;
                            mostrarMensajeDialog(FacesMessage.SEVERITY_ERROR, "El precio venta debe ser un número con máximo 6 decimales.");
                        }
                    }
                }
            } else {
            ...
            if (Validaciones.esDecimal(precioVentaDos.toString())) {
                if (precioVentaDos.compareTo(BigDecimal.ZERO) < 1) {
                    ...
                    if (Utilidades.BorrarCaract(precioVentaDos.toString(), "\\.").length() > 18) {
                        ...
                        if (precioVentaDos.scale() > 6) {
                            aux6 = false;
                            mostrarMensajeDialog(FacesMessage.SEVERITY_ERROR, "El precio venta dos debe ser un número con máximo 6 decimales.");
                        }
                    }
                }
            } else {
        ...
        if (porcentajeVenta != null || !porcentajeVenta.equals("")) {
            if (Validaciones.esDecimal(porcentajeVenta.toString())) {
                ...
                if (Utilidades.BorrarCaract(porcentajeVenta.toString(), "\\.").length() > 18) {
                    ...
                    if (porcentajeVenta.scale() > 6) {
                        aux7 = false;
                        mostrarMensajeDialog(FacesMessage.SEVERITY_ERROR, "El porcentaje de venta debe ser un número con máximo 6 decimales.");
                    }
                }
        ...
        if (porcentajeVentaDos != null || !porcentajeVentaDos.equals("")) {
            if (Validaciones.esDecimal(porcentajeVenta.toString())) {
                ...
                if (Utilidades.BorrarCaract(porcentajeVentaDos.toString(), "\\.").length() > 18) {
                    ...
                    if (porcentajeVentaDos.scale() > 6) {
                        aux8 = false;
                        mostrarMensajeDialog(FacesMessage.SEVERITY_ERROR, "El porcentaje de venta dos debe ser un número con máximo 6 decimales.");
                    }
                }
...
//        }
        if (aux4) {
            nuevoProducto.setPrecioCosto("" + precioCosto);
        }
        if (aux5) {
        ...
        if (aux6) {
            ...
            nuevoProducto.setPrecioVentaDos("" + precioVentaDos);
        }

        if (aux7) {
            nuevoProducto.setPorcentajeVenta("" + porcentajeVenta);
        }
        if (aux8) {

            nuevoProducto.setPorcentajeVentaDos("" + porcentajeVentaDos);
        }
//        if (aux9) {
...
//        }
    ...
    public void encerarDetalles() {
        ...
        precioVentaDos = BigDecimal.ZERO;
        porcentajeVenta = BigDecimal.ZERO;
        porcentajeVentaDos = BigDecimal.ZERO;
        unidadMedida = "";
