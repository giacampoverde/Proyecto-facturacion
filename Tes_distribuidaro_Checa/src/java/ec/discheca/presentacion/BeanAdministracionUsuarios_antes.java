...
@ManagedBean
@ViewScoped
public class BeanAdministracionUsuarios_antes implements Serializable {
    ...
    public BeanAdministracionUsuarios_antes() {
...
//                        }
    ...
    public void mostrarDialogPerfil() {
        if (usuarioSeleccionado != null) {
            ...
            try {
                ...
                Logger.getLogger(BeanAdministracionUsuarios_antes.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
    ...
    private void obtenerAsignacionUsuarioPorId() {
        try {
//            DAOAsignacionUsuarioEmpresa dao = new DAOAsignacionUsuarioEmpresa();
//            usuarioSeleccionado = dao.obtenerAsignacionUsuarioPorId(usuarioSeleccionado.getUsuarioAcceso().getIdUsuario());

        } catch (Exception ex) {
//            Logger.getLogger(BeanAdministracionClientesEmpresas.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
