...
public class BeanAuditoria implements Serializable {
    ...
    private void cargarDatatableConCliente() {
        try {
            ...
            Logger.getLogger(BeanAuditoria.class.getName()).log(Level.SEVERE, "Error al cargar los clientes", e);
        }
    }
            ...
            registrosLazy = new LazyDataModel() {
                ...
                public List load(int first, int pageSize, String sortField, SortOrder sortOrder, Map filters) {
                    ...
                    try {
                        ...
                        Logger.getLogger(BeanAuditoria.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    return registrosaud;
                }
