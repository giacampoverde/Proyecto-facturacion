...
@ManagedBean
@ViewScoped
public class BeanComprobanteRetencion implements Serializable {
...
//    private String secuencial;
    ...
    public BeanComprobanteRetencion() {
...
//                setTipoAmbienteEmisor(Valores.ambiente);
            ...
            Logger.getLogger(BeanComprobanteRetencion.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
        ...
        if (baseImponible != null) {
            if (Validaciones.validarNumero(baseImponible.toString())) {
                if (baseImponible.scale() <= 2) {
                    ...
                    valorRetenido=valorRetenido.setScale(2, RoundingMode.HALF_EVEN);
                } else {
...
//     */
    public void limpiarImpuestos() {
        ...
        baseImponible=baseImponible.setScale(2, BigDecimal.ROUND_HALF_UP);
        valorRetenido = BigDecimal.ZERO;
        valorRetenido=valorRetenido.setScale(2, BigDecimal.ROUND_HALF_UP);
        porcentajeARetener = BigDecimal.ZERO;
         porcentajeARetener=porcentajeARetener.setScale(2, BigDecimal.ROUND_HALF_UP);
        numeroDocSustento = "";
        codDocSustento = "";
        ...
        if (infoAdicional) {
            ...
            if (listaInfoAdicional.size() < 15) {
                if (nombreAdicional != null && !nombreAdicional.equals("") && valorAdicional != null && !valorAdicional.equals("")) {
                    ...
                    if (!Validaciones.isEmail(valorAdicional)) {
...
//        if (clienteEmpresaEmisor != null && clienteEmpresaReceptor != null) {
        if (clienteEmpresaEmisor != null) {
            ...
            try {
                ...
                Logger.getLogger(BeanComprobanteRetencion.class.getName()).log(Level.SEVERE, null, e);
            }
...
//                                    RequestContext.getCurrentInstance().execute("PF('wv-comprobante-pago').show();");
    ...
    public static void setSiguiente(boolean siguiente) {
        BeanComprobanteRetencion.siguiente = siguiente;
    }
    ...
    public Empresa getClienteEmpresaEmisor() {
        return clienteEmpresaEmisor;
    }

    public void setClienteEmpresaEmisor(Empresa clienteEmpresaEmisor) {
        this.clienteEmpresaEmisor = clienteEmpresaEmisor;
    }
