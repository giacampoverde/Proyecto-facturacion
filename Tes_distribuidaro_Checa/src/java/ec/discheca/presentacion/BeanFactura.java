...
////////////////////////nuevos /////////////////////
    ...
    public BeanFactura() {
        ...
        cantidad = BigDecimal.valueOf(redondear(Double.valueOf(cantidad.toString())));
            ...
            try {
                ...
                if (r != null) {
                    ...
                    if (tipoIdentificacion != 4 && tipoIdentificacion != 5 && tipoIdentificacion != 6) {
                        ...
                        if (aux1) {
//                            MensajesPrimefaces.mostrarMensajeDialog(FacesMessage.SEVERITY_INFO, "cliente no registrado");
                            ...
                            correo2Receptor = "";
                            direccionReceptor = "";
                            RequestContext.getCurrentInstance().execute("PF('dialogDetalleAdicionalWV2').show();");
                        }
                    }
            ...
            MensajesPrimefaces.mostrarMensajeDialog(FacesMessage.SEVERITY_INFO, "Debe ingresar un RUC/Cédula.");
        }
    }
    ...
    public void encerarDetalles() {
        ...
        descuentoDetalle = descuentoDetalle.setScale(2, BigDecimal.ROUND_DOWN);
        descuento = new BigDecimal(BigInteger.ZERO);
         descuento = descuento.setScale(2, BigDecimal.ROUND_DOWN);
    ...
    public boolean generarFacturaElectronica() {
        ...
        try {
            ...
            Logger.getLogger(BeanFactura.class.getName()).log(Level.SEVERE, null, e);
        }
...
//            secuencial = this.instanciarDAOSecuencial().obtenerSecuencialPorRucYAmbiente(cs.obtenerRUCEmpresaSesionActiva());
    ...
    public void generarRIDE() {
        try {
            ...
            Logger.getLogger(BeanFactura.class
...
//    }
    ...
    public boolean isDatosCliente2() {
        return datosCliente2;
    }

    public void setDatosCliente2(boolean datosCliente2) {
        this.datosCliente2 = datosCliente2;
    }
    ...
    public Secuencial getSecuencialmostrar() {
        return secuencialmostrar;
    }

    public void setSecuencialmostrar(Secuencial secuencialmostrar) {
        this.secuencialmostrar = secuencialmostrar;
    }
