...
@ManagedBean
@ViewScoped
public class BeanNotaCredito_antes {
...
//                    Documento documentoAsociado = doc.obtenerUno(comprobanteDeSustento.getIdComprobante());
                ...
                Logger.getLogger(BeanNotaCredito_antes.class
    ...
    private DAOClienteEmpresa instanciarDAOClienteEmpresa() {
        ...
        try {
            ...
            Logger.getLogger(BeanNotaCredito_antes.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//                            detalles.add(detalle);
    ...
    public boolean generarNotaCreditoElectronica() {
        ...
        try {
            ...
            Logger.getLogger(BeanNotaCredito_antes.class.getName()).log(Level.SEVERE, null, e);
        }
