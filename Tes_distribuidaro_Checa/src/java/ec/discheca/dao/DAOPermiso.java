 ...
 */
public class DAOPermiso extends DAO{
    public DAOPermiso() throws Exception {
        super(DAO.$MODULO_DISCHECA);
    }

    public DAOPermiso(Session currentSession) throws Exception {
        super(currentSession);
    }

    public DAOPermiso(DAO dao) throws Exception {
        super(dao);
    }
    
     public List<Permiso> obtenerPermiso(){
        Query q=currentSession.createQuery("from Permiso");
        return q.list();
    }
