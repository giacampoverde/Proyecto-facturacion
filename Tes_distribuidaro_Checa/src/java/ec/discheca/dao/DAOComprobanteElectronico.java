...
public class DAOComprobanteElectronico extends DAO {
    ...
    public boolean actualizarValorTotalFacturaComprobante(String id, String valorTotalFactura) {
        ...
        try {
            ...
            comprobante.setValorTotalFacturaComprobanteElectronico(valorTotalFactura);
            currentSession.merge(comprobante);
            actualizar = true;
        } catch (HibernateException e) {
...
//        }
    ...
    public byte[] generarPDFComprobante(ec.discheca.comprobanteelectronico.esquema.comprobantebase.ComprobanteElectronico comprobante) throws Exception {
        byte[] pdfByte = null;
    ...
    public ComprobanteElectronico guardarComprobanteElectronico(String _claveAcceso, String _codigoEstablecimiento,
            ...
            byte[] _comprobanteFirmado) throws Exception {
        ...
        if (_valorTotal != null) {
            comprobante_electronico.setValorTotalFacturaComprobanteElectronico(_valorTotal);
        }
