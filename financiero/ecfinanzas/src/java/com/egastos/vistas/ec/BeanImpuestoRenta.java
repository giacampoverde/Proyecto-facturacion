    ...
    public void impuestoRenta() {
        ...
        try {
            ...
            if (!periodoFiscal.equals("")) {
                ...
                MensajesPrimefaces.mostrarMensaje(FacesMessage.SEVERITY_ERROR, "Debe ingresar un periodo fiscal.");
            }
...
//            jasperPrint = JasperFillManager.fillReport("C:\\reportesEgastos\\Renta.jasper", parametros, a);
            //pro
//              jasperPrint = JasperFillManager.fillReport(Valores.VALOR_RERPOTERENTA, parametros, a);
            jasperPrint2 = JasperFillManager.fillReport(Valores.VALOR_RERPOTERENTA, parametros, new JREmptyDataSource());
//              jasperPrint2 = JasperFillManager.fillReport("C:\\reportesEgastos\\Renta2.jasper", parametros,new JREmptyDataSource());
            byte[] bites = JasperExportManager.exportReportToPdf(jasperPrint2);
            if (bites.length == 919) {
