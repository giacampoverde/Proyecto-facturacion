...
public class ConsultaComprobante {
     ...
     */
    public ec.discheca.firma.sri.pruebas.RespuestaSRI obtenerRespuestaSRI(String claveDeAcceso) throws Exception {
     ...
     */
    public ec.discheca.firma.sri.pruebas.RespuestaSRI parsearRespuestaSRI(RespuestaComprobante _respuesta) {
        ec.discheca.firma.sri.pruebas.RespuestaSRI respComprSri = new ec.discheca.firma.sri.pruebas.RespuestaSRI();
     ...
     */
    public ec.discheca.firma.sri.pruebas.RespuestaSRI cambiarEstado(ec.discheca.firma.sri.pruebas.RespuestaSRI _respuesta) {
